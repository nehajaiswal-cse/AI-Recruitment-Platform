...
function Candidate() {
  ...
  try {
    await removeCandidate(selectedCandidate._id);

    // Remove selected candidate from UI
    setSelectedCandidate(null);
            ...
            >
              ...
              >
                <Box>
                  ...
                  >
                    Review and rank candidates using
            ...
            >
              ...
              {selectedCandidate && (
                ...
                >
                  ...
                  <Box id="candidate-copilot">
                    {selectedCandidate?.applicationId && (
                      <CandidateCopilot
                        applicationId={
                          typeof selectedCandidate.applicationId ===
                          "object"
                            ? selectedCandidate
                                .applicationId
                                ._id
